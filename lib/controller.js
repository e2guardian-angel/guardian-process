...
Controller.prototype.deployMongo = async function(authVolumePath) {
    ...
    this.kubeGet(this.paths.resources.volumes.auth).catch(async err => {
        try {
    ...
    this.kubeGet(this.paths.resources.volumeClaims.auth).catch(async err => {
        try {
...
Controller.prototype.deployGuardian = async function() {
 ...
 */
Controller.prototype.deployAll = async function() {
